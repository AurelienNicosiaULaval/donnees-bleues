...
::: {.card-grid}
::: {.db-card}
<img class="db-card-image" src="assets/cards/catalogue.jpg" alt="Illustration du catalogue de jeux de données">
...
::: {.db-card}
<img class="db-card-image" src="assets/cards/zero-dechet.jpg" alt="Illustration du cadre zéro déchet">
...
::: {.db-card}
<img class="db-card-image" src="assets/cards/activites.jpg" alt="Illustration des activités pédagogiques">
...
Cette version contient six fiches de jeux de données québécois :

- l'état des stations BIXI;
- les statistiques des bibliothèques publiques du Québec;
- les stations du Réseau de surveillance de la qualité de l'air du Québec.
- le suivi physicochimique et bactériologique des rivières et du fleuve;
- le registre des prélèvements d'eau autorisés;
- les cohortes de diplomation.
