...
::: {.db-card}
<img class="db-card-image" src="assets/cards/catalogue.png" alt="Illustration de la collection STT-1100">

### Québec pour STT-1100

Explorer six jeux québécois structurés pour des laboratoires de science des données de premier cycle.

[Ouvrir la collection](datasets/quebec-stt1100/index.qmd)
:::
:::
...
Le catalogue rassemble des fiches de jeux de données québécois sur l'environnement, l'eau, la mobilité, l'éducation, la démographie, la sécurité publique, les services municipaux et les politiques publiques. Il inclut maintenant une collection dédiée aux laboratoires de science des données de premier cycle : [Québec pour la science des données (STT-1100)](datasets/quebec-stt1100/index.qmd).
